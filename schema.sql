...
INSERT INTO `recipe`
	(`name`, `narrative`, `courseid`, `diettype`, `serves`, `imageurl`)
	VALUES
	...
	<p>Heat a barbecue or griddle pan until hot. Brush the burgers with a little oil and cook for 4 minutes on each side or until cooked through. Serve the burgers in soft rolls with lettuce, mint, coriander and chilli sauce.</p>', 1, NULL, 2, 'http://www.bbcgoodfood.com/sites/bbcgoodfood.com/files/recipe_images/recipe-image-legacy-id--1035715_11.jpg'),
	...
	<p>Sprinkle the pie crust with half of the shredded Cheddar Cheese and then add slices of fish.  Then, sprinkle the other half of the cheese.  Combined the reserved poaching liquid with 2 eggs and pour into pie plate.  Back for 30 min.  Remove from oven and arrange the tomatoes around the edge, skin up.  Bake for 10 more minutes until set.  Garnish with chopped green onions or chives.</p>', 1, NULL, 4, 'https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQ7VsrAjYqQNKQNc0d4Zk3RyCK3LJXqbLYp7KVoVKBAg0f-O4dY'),
	...
	<p>Transfer the bean mixture to a flameproof dish and sprinkle the crumbled feta over the top. Cook under the hot grill until the cheese is soft and just starting to brown. Serve hot with corn chips on the side for dipping.</p>', 3, 'Vegetarian', 4, 'http://pinchmysalt.com/wp-content/uploads/2007/06/black-bean-dip-for-web.jpg'),
	...
	<p>Pour the icing on top, spreading gently so as not to disturbed what ever flakiness the top pastry has. Cover and cool for a minimum of three hours or overnight.</p>", 4, 'Vegetarian', 16, 'http://www.murrayriver.com.au/images/event/2011/3/583/vanilla_slices-large.jpg');
...
INSERT INTO `recipe_ingredient` (`name`, `quantity`, `section`, `units`, `recipeid`)
	...
	('chopped fresh coriander', 1, NULL, 'tablespoon', 1),
	('finely grated lime zest', 1, NULL, 'teaspoon', 1),
	('fish sauce', 1, NULL, 'teaspoon', 1),
	('caster sugar', 1, NULL, 'teaspoon', 1),
	...
	('butter, melted', 2, NULL, 'tablespoon', 2),
	...
	('salt', 1.5, NULL, 'teaspoon', 3),
	('celery salt', 0.25, NULL, 'teaspoon', 3),
	('black pepper', 0.25, NULL, 'teaspoon', 3),
	('sage', 0.25, NULL, 'teaspoon', 3),
	...
	('pesto', 0.5, 'Potato Salad', 'tablespoon', 4),
	...
	('vanilla extract', 1, NULL, 'teaspoon', 6),
	('thickened cream', 0.75, NULL, 'cup', 6),
	('icing sugar', 1.5, 'Icing', 'cup', 6),
	('soft butter', 1, 'Icing', 'teaspoon', 6),
...
INSERT INTO `recipe_segmented_ingredient` (`recipeid`, `name`, `quantity`, `section`, `units`, `replaces`)
	...
	(3, 'salt', 0.75, NULL, 'teaspoon', NULL),
...
INSERT INTO `recipe_step_ingredient` (`recipeid`, `name`, `quantity`, `section`, `units`, `replaces`)
	...
	(3, 'salt', 1.5, 'Pie Filling', 'teaspoon', 22),
	(3, 'celery salt', 0.25, 'Pie Filling', 'teaspoon', 23),
	(3, 'black pepper', 0.25, 'Pie Filling', 'teaspoon', 24),
	(3, 'sage', 0.25, 'Pie Filling', 'teaspoon', 25),
	(3, 'ground cloves', NULL, 'Pie Filling', 'pinch', 26),
	(3, 'potatoes', 3, 'Pie Filling', NULL, NULL),
	(3, 'flour', 2.5, 'Pie crust', 'cup', NULL),
	(3, 'salt', 0.75, 'Pie crust', 'teaspoon', NULL),
